function [data, time, Fs] = read_Intan_RHD2000_file_inline(file, path)
...
num_data_blocks = floor(bytes_remaining / bytes_per_block); % NORMALLY NOT FLOORED
